 ...
 *
 * S8 owns the real status bar; the provisional summary strip this file used
 * to render is gone (S8 plan §4.3) — `StatusBar` (`status-bar.tsx`) replaces
 * it. The card itself, this component, and the i18n keys below are
 * permanent (S7 plan §6.2).
 *
